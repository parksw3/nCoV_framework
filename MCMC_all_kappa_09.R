...
sample_data$`Imai et al. (2020)`$kappa <- 0.9
...
V <- matrix(0, 6, 6)
diag(V) <- c(2e-3, 0.01, 0.3, 1.5, 0.1, 0.1)/10
...
MCMC_all_kappa_09 <- as.mcmc.list(reslist)

save("MCMC_all_kappa_09", file="MCMC_all_kappa_09.rda")
