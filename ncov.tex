...
We gathered information on estimates of \Ro and their assumptions about the underlying generation-interval distributions from 6 articles that were published online between January 24 and January 26, 2020 (Table 1).
...
\hline
Study 5 & $\gammdist(\mathrm{mean}=5.47, \alpha=54)$ & $\mathrm{Uniform}(7.6, 8.4)^\ast$ & 0.2\\
\hline
Study 6 & $\exp(r \bar G)^\dagger$ & $\mathrm{Uniform}(6, 10)$ & 0\\
\hline
\end{tabular}
\end{center}
\caption{
...
\fref{eff} shows how propagating uncertainty in different combinations would affect estimates and CIs for \Ro. For illustrative purposes, we use our pooled estimates, which may represent a reasonable proxy for the state of knowledge as of January 26.
...
For example, recalculating \Ro for Study 6 by using our pooled estimate of $r$ gives $\Ro = 3.9$ (95\% CI: 2.3--9.8), which is much wider than the uncertainty range they reported (2.0--3.1).
...
Here, we focused on the estimates of \Ro that were published within a very short frame of time (January 24--26).
...
We reviewed 6 modeling studies of the novel coronavirus outbreak that were published online between January 24 and January 26, 2020 (Table 1).
