...
\cite{liuncov} modeled the observed incidence up to January 23 as a function of previous incidence, the generation-interval distribution, and the basic reproductive number using a Poisson likelihood \citep{forsberg2008likelihood}.
