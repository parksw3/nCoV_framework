...
for example, Study 6 appears to be an outlier but the authors, in fact, explore several different scenarios with changes in reporting rate, under which their estimates of \Ro are similar to other estimates.
