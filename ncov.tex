...
We use weakly informative priors on hyperparameters representing pooled means and uninformative priors on hyperparameters representing between-study standard deviations:
\begin{linenomath*}
\begin{equation}
\begin{aligned}
