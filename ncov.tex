...
This is because Study 1 assumes an exponentially distributed generation interval ($\kappa=1$): estimates that include this assumption make \Ro relatively insensitive and thus tend have particularly narrow confidence intervals.
