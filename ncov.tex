...
As the epidemic progresses, many disease modelers have prioritized
\bmb{focused on? (this is what we say in the body of the paper)} estimating the basic reproductive number \Ro, the average number of secondary cases caused by a primary case.
...
We also use our framework to unravel \bmb{tease apart?} which assumptions of these different models led to their different estimates and confidence intervals.
...
\caption{
  ...
  \bmb{May I suggest that you use {\tt theme\_set(theme\_bw(base\_size=18))} (or some large value) rather than (or in addition to) increasing the sizes of the points and lines?}
