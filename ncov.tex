...
We then apply our framework to early estimates of \Ro for the 2019-nCoV outbreak\jsw{, estimating the \Ro from the pooled distribution as 2.9 (95\% CI: 2.1-4.5)}.
...
\swp{JSW suggests including our pooled estimate of R in the abstract. Not sure if we want that. The pooled estimates have some caveats and they're based on very early estimates. I think it's OK to leave them out.}
\swp{DJDE suggests using overline G rather than bar G. I think overline looks ugly.}

\swp{Some of the papers that we look at have been published now. Where do we want to address that? Discussion? Methods? I'm thinking of adding a sentence to the Methods section where we review 7 papers: ``Some of these studies have now been published in peer reviewed journals or have been updated with better quantification of uncertainties [CITE].'' I think this is a fair thing to say.}
...
\swp{I propose we drop these two sentences.}
...
For emerging pathogens such as 2019-nCoV, we expect the reporting rate likely to be very low until sufficient resources become available and case definitions become certain;
