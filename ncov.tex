...
Then, the the family of parameter sets $(\bar{G}_{i,m}, \kappa_{i,m}, r_{i,m})$ defines an empirical parameter distribution for each study $i$ without having to re-fit each model.
In other words, we do not explicitly rely on the observed data or dynamical models; 
we simply rely on reported estimates.
