...
\newline
\\
Sang Woo Park BSc\textsuperscript{1,*}
Benjamin M.\ Bolker PhD\textsuperscript{2,3,4}
David Champredon PhD\textsuperscript{5}
David J.\,D.\ Earn PhD\textsuperscript{3,4}
Michael Li PhD\textsuperscript{2}
Joshua S.\ Weitz PhD\textsuperscript{6, 7}
Bryan T.\ Grenfell PhD\textsuperscript{1,8,9}
Jonathan Dushoff PhD\textsuperscript{2,3,4,*}
\\
\bigskip
...
We reviewed 7 studies that were published online between January 23--26, 2020.
...
We assess early estimates of \Ro for the 2019-nCoV outbreak using the pooled estimates.

\subsection*{Findings}

We find that most early estimates of \Ro rely on strong assumptions, especially about the generation-interval dispersion.
In particular, estimates that rely on narrow generation-interval distributions are overly sensitive to estimates of the exponential growth rate.
...
% 7 analyses of the 2019-nCoV outbreak were published online as pre-prints between January 23--26, 2020.
% Their modeling approaches varied widely and estimates of uncertainties in \Ro ranged from 1.5 to 7.1.
...
% Also on January 30, 2020, WHO declared the outbreak a Public Health Emergency of International Concern \cite{whoemer}.
...
% Assuming fixed parameter values can lead to overly strong conclusions \cite{elderd2006uncertainty}.
