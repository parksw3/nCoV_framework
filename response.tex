...
\jd{I'm confused. Isn't the reason to use Bayesian averaging is that it does weight implicitly by certainty?}
...
\jd{Do we examine effective sample size? Can we report them?}
