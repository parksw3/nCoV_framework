...
\jd{What's up with the line breaks??}
As the disease continues to spread, 
many researchers have published
analyses of the outbreak, many focusing in particular on
...
because it provides information about the level of intervention required to interrupt transmission \citep{anderson1991infectious}, and about the final size of the outbreak \citep{anderson1991infectious, ma2006generality}.
\jd{We really only need one cite for this whole s., but I think Ma will make David happy.}
...
the exponential growth rate $r$, which can be estimated reliably from incidence data \citep{mills2004transmissibility, nishiura2009transmission, ma2014estimating}. \jd{Trimmed references; in particular, don't really want to point people to Chowell for stats.}
...
\jd{Are you still using exponential?}
...
\jd{use mean (not rate) and shape; specify units for the means.}
