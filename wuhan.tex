...
we model this parameter as a gamma distribution with mean of 2.92 and a shape parameter of 67, which has a 95\% probability of containing a value between 2.28 and 3.67 (see Table 2 for the list of all distributions).
